...
import 'package:google_fonts/google_fonts.dart';
 class Vidplayer4 extends StatefulWidget {
  const Vidplayer4({super.key});

  @override
  State<Vidplayer4> createState() => _VidplayerState();
}

class _VidplayerState extends State<Vidplayer4> {
