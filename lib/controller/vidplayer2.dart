...
import 'package:google_fonts/google_fonts.dart';
 class Vidplayer2 extends StatefulWidget {
  const Vidplayer2({super.key});

  @override
  State<Vidplayer2> createState() => _VidplayerState();
}

class _VidplayerState extends State<Vidplayer2> {
